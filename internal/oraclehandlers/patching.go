...
func disableAutostart(ctx context.Context, logger *zap.SugaredLogger, params map[string]string) error {
	...
	logger.Infow("Detected startup mechanism", "mechanism", mechanism.String())
...
func setAutostartInOratab(filePath string, targetSID string, enable bool) error {
	...
	for _, line := range lines {
		...
		// NOMUTANTS -- Mutant doesn't alter behavior; empty lines are correctly handled and preserved regardless of this check.
