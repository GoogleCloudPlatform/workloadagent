...
import (
	...
	"github.com/GoogleCloudPlatform/workloadagent/internal/sqlservermetrics/sqlservermetricsutils"
...
func (c *V1) CollectSQLMetrics(ctx context.Context, timeout time.Duration) []sqlservermetricsutils.MetricDetails {
	var details []sqlservermetricsutils.MetricDetails
	for _, rule := range SQLMetrics {
		func() {
			...
			details = append(details, sqlservermetricsutils.MetricDetails{
				Name:   rule.Name,
